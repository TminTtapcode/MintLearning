...
Học một learning unit bằng resource có focus, example, practice và check.
...
`unit intro → resource → example → practice → assessment`
...
- `GET /api/v1/learning-units/{id}`
- `POST /api/v1/learning-sessions/{id}/items/{itemId}/complete`
